...
export class FooterComponent {
  navLinks1 = [
    ...
    { label: '事業内容', routerLink: '/services' },
    { label: '施工事例', routerLink: '/cases' },
    { label: '採用情報', routerLink: '/recruit' },
  ];

  navLinks2 = [
    { label: 'お知らせ', routerLink: '/news' },
    { label: 'よくある質問', routerLink: '/faq' },
    { label: 'アクセス', routerLink: '/access' },
    { label: 'プライバシーポリシー', routerLink: '/privacy-policy' },
  ];
}
